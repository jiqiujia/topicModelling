...
class TopicModelMerge(object):
    ...
    def conv_topic_word(self):
        ...
        """
        topic_word = [[] for _ in range(self._num_topics)]
    ...
    def select_topk(self, topic_word, topic_sum, topk):
        ...
        """
        topk_items = [[] for _ in range(self._num_topics)]
    ...
    def reduce_topic(self, topk, Jac_thresh, Jac_opt, output_file):
        ...
        overlap_pair = []
        for tid1 in range(self._num_topics - 1):
            for tid2 in range(tid1 + 1, self._num_topics):
